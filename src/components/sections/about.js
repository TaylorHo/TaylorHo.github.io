...
const About = () => {
  ...
  const skills = ['JavaScript (ES6+)', 'React', 'Node.js', 'Next.js', 'Firebase', 'Flutter'];
    ...
    <StyledAboutSection id="about" ref={revealContainer}>
      ...
      <div className="inner">
        <StyledText>
          <div>
            <p>
              Olá! Eu sou o Taylor, amo tudo ligado à tecnologia e sou apaixonado pela segurança de
              aplicações (ou explorar a falta dela). Crio apps mobile, desktop e web, o foco é ser
              utilizável em todas as plataformas possíves.
            </p>
